...
const tools = [
  ...
  // P4 - Project Management
  {
    ...
    description: "Set the project root paths, replacing any existing paths.",
    inputSchema: {
      type: "object",
      properties: {
        paths: {
          type: "array",
          items: { type: "string" },
          description: "Array of absolute paths to set as project roots",
        },
      },
      required: ["paths"],
    },
  ...
  {
    name: "AddProjectPath",
    description: "Add a folder to the project root paths.",
    inputSchema: {
      type: "object",
      properties: {
        path: {
          type: "string",
          description: "Absolute path of folder to add to project",
        },
      },
      required: ["path"],
    },
  },
  {
    ...
    description: "Remove a folder from the project root paths.",
    inputSchema: {
      type: "object",
      properties: {
        path: {
          type: "string",
          description: "Absolute path of folder to remove from project",
        },
      },
      required: ["path"],
    },
  ...
  // P5 - Buffer Range Operations
  {
    ...
    description: "Get text from a specific range in the active editor buffer.",
    inputSchema: {
      type: "object",
      properties: {
        startRow: { type: "number", description: "Start line (0-indexed)" },
  ...
  },
  {
    ...
    description: "Replace text in a specific range in the active editor buffer.",
    inputSchema: {
      type: "object",
      properties: {
        startRow: { type: "number", description: "Start line (0-indexed)" },
        ...
        endRow: { type: "number", description: "End line (0-indexed)" },
        endColumn: { type: "number", description: "End column (0-indexed)" },
        text: { type: "string", description: "The text to insert at the range" },
      },
  ...
  },
  {
    ...
    description: "Find all matches of a pattern within a specific range in the active editor.",
    inputSchema: {
      type: "object",
      properties: {
  ...
  {
    name: "ScanWorkspace",
    description: "Search for a pattern across all files in the project. Returns file paths and matches.",
    inputSchema: {
      type: "object",
      properties: {
        ...
        paths: {
          type: "array",
          items: { type: "string" },
          description: "Optional glob patterns to limit search scope (e.g., ['**/*.js'])",
        },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        paths: {
          type: "array",
          items: { type: "string" },
          description: "Optional glob patterns to limit scope (e.g., ['**/*.js'])",
        },
        dryRun: { type: "boolean", description: "If true, only return matches without replacing. Default: false" },
      },
